...
# Substitute: physics-bodies, coworld-physics-bodies, 2.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-physics-bodies:ci)
#   SMOKE_SLUG                 game slug                        (physics-bodies)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/physics-bodies)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/physics-bodies-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-physics-bodies:ci}}"
slug="${SMOKE_SLUG:-physics-bodies}"
